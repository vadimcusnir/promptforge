...
export const SEVEND_SCALES = ['personal_brand', 'solo', 'startup', 'boutique_agency', 'smb', 'corporate', 'enterprise'] as const;
...
export const SEVEND_RESOURCES = ['minimal', 'solo', 'lean_team', 'agency_stack', 'full_stack_org', 'enterprise_budget'] as const;
export const SEVEND_APPLICATIONS = ['training', 'audit', 'implementation', 'strategy_design', 'crisis_response', 'experimentation', 'documentation'] as const;
export const SEVEND_OUTPUT_FORMATS = ['txt', 'md', 'checklist', 'spec', 'playbook', 'json', 'yaml', 'diagram', 'bundle'] as const;
...
export const DOMAIN_DEFAULTS: Record<SevenDDomain, Omit<SevenDConfig, 'domain'>> = {
  ...
  fintech: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  ecommerce: { scale: 'smb', urgency: 'sprint', complexity: 'standard', resources: 'agency_stack', application: 'implementation', output_format: 'md' },
  education: { scale: 'smb', urgency: 'planned', complexity: 'standard', resources: 'lean_team', application: 'training', output_format: 'md' },
  healthcare: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  legal: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  marketing: { scale: 'boutique_agency', urgency: 'sprint', complexity: 'standard', resources: 'agency_stack', application: 'implementation', output_format: 'md' },
  media: { scale: 'smb', urgency: 'sprint', complexity: 'standard', resources: 'agency_stack', application: 'implementation', output_format: 'md' },
  ...
  government: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  energy: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  transportation: { scale: 'corporate', urgency: 'planned', complexity: 'advanced', resources: 'full_stack_org', application: 'implementation', output_format: 'spec' },
  logistics: { scale: 'corporate', urgency: 'planned', complexity: 'advanced', resources: 'full_stack_org', application: 'implementation', output_format: 'spec' },
  ...
  retail: { scale: 'smb', urgency: 'sprint', complexity: 'standard', resources: 'agency_stack', application: 'implementation', output_format: 'md' },
  travel: { scale: 'smb', urgency: 'planned', complexity: 'standard', resources: 'lean_team', application: 'implementation', output_format: 'md' },
  hospitality: { scale: 'smb', urgency: 'planned', complexity: 'standard', resources: 'lean_team', application: 'implementation', output_format: 'md' },
  gaming: { scale: 'startup', urgency: 'sprint', complexity: 'advanced', resources: 'lean_team', application: 'experimentation', output_format: 'md' },
  entertainment: { scale: 'smb', urgency: 'sprint', complexity: 'standard', resources: 'agency_stack', application: 'implementation', output_format: 'md' },
  telecom: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  insurance: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
  banking: { scale: 'enterprise', urgency: 'planned', complexity: 'expert', resources: 'full_stack_org', application: 'audit', output_format: 'spec' },
