...
export class AuditLogger {
  ...
  logRun(params: {
    ...
    console.log(`[AuditLogger] Logged run ${params.run_id}: ${verdict} (${params.tokens} tokens, $${params.cost.toFixed(4)})`)
  }
  ...
  private sanitizeMetadata(metadata?: Record<string, any>): Record<string, any> | undefined {
    ...
    const allowedFields = [
      "version", "tier", "feature_flags", "experiment_id", "ab_test_variant",
      "browser", "os", "device_type", "screen_resolution", "timezone",
      "request_id", "trace_id", "parent_span_id", "sampling_rate"
    ]
