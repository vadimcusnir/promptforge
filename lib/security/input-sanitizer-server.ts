// Server-side only input sanitizer (Edge Runtime compatible)
// This version doesn't use jsdom and focuses on pattern-based sanitization
...
export const inputSanitizerServer = new InputSanitizerServer()
