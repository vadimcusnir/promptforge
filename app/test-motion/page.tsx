...
import { CheckCircle, ArrowRight, Zap, Download } from "lucide-react";

export default function TestMotionPage() {
  const [currentStep, setCurrentStep] = useState<
    "configure" | "generate" | "test" | "export"
  >("configure");
      ...
      <div className="max-w-6xl mx-auto space-y-12">
        <header className="text-center space-y-4">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Demonstrating the 3-intent motion system: Guide (CTA feedback),
            State (loading/success), and Explain (step transitions). All motion
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-xs text-gray-500">
                  Shows toast with state animation
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="bg-gray-900/30 rounded-lg p-6 text-sm text-gray-400">
          ...
          <ul className="space-y-2">
            <li>
              • <strong>Guide:</strong> CTA hover (-1px), focus rings
              (180-220ms)
            </li>
            <li>
              • <strong>State:</strong> Loading, success, copied badges
              (120-600ms)
            </li>
            <li>
              • <strong>Explain:</strong> Step transitions (8-12px slide,
              300-400ms)
            </li>
            <li>
              • <strong>Respect:</strong> prefers-reduced-motion disables all
              animations
            </li>
            <li>
              • <strong>Budget:</strong> 1 primary + max 4 micro per page, ≤1%
              CPU
            </li>
          </ul>
        </section>
