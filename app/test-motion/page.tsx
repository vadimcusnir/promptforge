      ...
      <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="bg-gray-900/50 rounded-lg p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center space-y-4">
                ...
                }} variant="secondary" size="sm" disabled={isGenerating}>
        ...
        <section className="bg-gray-900/30 rounded-lg p-6 text-sm text-gray-400">
          ...
          <ul className="space-y-2">
            <li>• <strong>Guide:</strong> CTA hover (-1px), focus rings (180-220ms)</li>
            <li>• <strong>State:</strong> Loading, success, copied badges (120-600ms)</li>
            <li>• <strong>Explain:</strong> Step transitions (8-12px slide, 300-400ms)</li>
            <li>• <strong>Respect:</strong> prefers-reduced-motion disables all animations</li>
            <li>• <strong>Budget:</strong> 1 primary + max 4 micro per page, ≤1% CPU</li>
          </ul>
        </section>
      </div>
    </div>
