          ...
          <section>
            ...
            <div className="space-y-4 text-gray-300 leading-relaxed">
              ...
              <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-6 space-y-4">
                <div>
                  <h4 className="font-bold text-red-400 mb-2">Free/Trial Plans</h4>
                  <ul className="text-sm space-y-1 ml-4">
                    <li>• Limited export formats (txt, md)</li>
                    <li>• Watermarked exports: "TRIAL — Not for Redistribution"</li>
                    <li>• Personal use only, no commercial redistribution</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-bold text-yellow-400 mb-2">Pro Plan</h4>
                  <ul className="text-sm space-y-1 ml-4">
                    <li>• Full export formats (txt, md, pdf, json)</li>
                    <li>• Standard license notices</li>
                    <li>• Commercial use permitted</li>
                  </ul>
                </div>
                <div>
                  <h4 className="font-bold text-green-400 mb-2">Enterprise Plan</h4>
                  <ul className="text-sm space-y-1 ml-4">
                    <li>• All export formats including bundle.zip</li>
                    <li>• Professional license notices</li>
