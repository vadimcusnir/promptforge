      ...
      <main className="container mx-auto max-w-[1240px] px-6 py-24 space-y-16">
        ...
        <section className="pf-block sweep p-8 text-center">
          ...
          <h1 className="text-h1 text-[#ECFEFF] mb-4">
            Tactical <span className="kw" data-glitch>
          ...
          <div className="flex gap-4 justify-center">
            <button className="btn-notched px-8 py-4">
              Notched Button
            </button>
            <button className="btn px-8 py-4">
              Sharp Button
            </button>
          </div>
        </section>
        ...
        <section className="pf-block p-8">
          ...
          <h2 className="text-h2 text-[#ECFEFF] mb-4">
            Block System with <span className="kw" data-glitch>
          ...
          <div className="grid md:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <div className="space-y-4">
                ...
                <button className="btn w-full" disabled>Disabled Sharp</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <button className="btn-notched w-full" disabled>Disabled Notched</button>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="pf-block p-8 text-center">
          ...
          <p className="text-body text-[#ECFEFF]/80 space-y-4">
            <span>Watch these keywords glitch on scroll:</span><br/>
            <span className="kw" data-glitch>
