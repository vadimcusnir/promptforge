      ...
      <div className="sticky top-0 z-50 bg-black/80 backdrop-blur-sm border-b border-gray-800">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-[#d1a954]">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <h1 className="text-4xl font-bold font-montserrat">PromptForge™ Guides</h1>
          </div>
        ...
        <div className="flex gap-8">
          ...
          <div
            className={`
            fixed lg:static inset-y-0 left-0 z-40 w-80 bg-[#1a1a1a] border-r border-gray-800 
            transform transition-transform duration-300 ease-in-out lg:transform-none
            ${sidebarOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}
          `}
          >
            <div className="p-6">
              <h3 className="text-lg font-semibold mb-6 text-[#d1a954]">Categories</h3>
                  ...
                  return (
                    <button
                      ...
                      className={`
                        ...
                        ${
                          isActive
                            ? "bg-[#d1a954]/20 border border-[#d1a954]/30 text-[#d1a954]"
                            : "hover:bg-gray-800 text-gray-300 hover:text-white"
                        }
                      `}
                    >
                      <div className="flex items-center gap-3">
                        <Icon className={`w-5 h-5 ${isActive ? "text-[#d1a954]" : category.color}`} />
              ...
              {completedCount > 0 && completedCount < guides.length && (
                <div className="mt-8 p-4 bg-gradient-to-r from-[#d1a954]/10 to-transparent border border-[#d1a954]/20 rounded-lg">
                  <h4 className="font-semibold text-[#d1a954] mb-2">Continue Learning</h4>
                  <p className="text-sm text-gray-400 mb-3">
                    You're making great progress! Keep going to master PromptForge.
                  </p>
                  <Button size="sm" className="w-full bg-[#d1a954] hover:bg-[#d1a954]/80 text-black">
            ...
            <div className="grid gap-6">
              {filteredGuides.map((guide) => {
                ...
                return (
                  <Card
                    key={guide.id}
                    className="bg-[#1a1a1a] border-gray-800 hover:border-[#d1a954]/30 transition-all"
                  >
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            <CardTitle className="text-xl font-montserrat">{guide.title}</CardTitle>
                    ...
                    <CardContent>
                      <div className="flex gap-3">
                        <Button
                          variant="outline"
                          className="flex-1 border-gray-700 hover:border-[#d1a954] hover:text-[#d1a954] bg-transparent"
                        >
                        ...
                        {guide.generatorConfig && (
                          <Button
                            ...
                            className="flex-1 bg-[#d1a954] hover:bg-[#d1a954]/80 text-black"
                          >
                            <Play className="w-4 h-4 mr-2" />
                            Try in Generator
                          </Button>
            ...
            <div className="mt-12 text-center">
              <Card className="bg-gradient-to-r from-[#d1a954]/10 to-transparent border-[#d1a954]/20">
                <CardContent className="p-8">
                  <h3 className="text-2xl font-bold mb-4 font-montserrat">Ready to forge your first prompt?</h3>
                  ...
                  <Button
                    ...
                    className="bg-[#d1a954] hover:bg-[#d1a954]/80 text-black"
                  >
                    Open Generator
