      ...
      <main className="max-w-7xl mx-auto px-4 pb-16">
        ...
        <header className="text-center mb-16">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative">
              <div className="w-24 h-24 border-4 border-[#FFD700] rounded-full flex items-center justify-center animate-pulse">
                <FileText className="w-12 h-12 text-[#FFD700]" />
              </div>
              <div className="absolute -top-2 -right-2 bg-[#FFD700] text-black text-xs px-2 py-1 rounded-full font-bold animate-bounce">
                VERIFIED
              </div>
            </div>
          </div>
          ...
          <p className="text-2xl text-[#FFD700] font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section>
              <h2 className="text-3xl font-semibold mb-6 text-[#FFD700] flex items-center gap-3">
                <Shield className="w-8 h-8" />
                Description of Service
              </h2>
              <div className="space-y-4 text-[#E0E0E0] leading-relaxed text-lg">
                <p>
                  PromptForge™ is a cognitive operating system for AI prompt engineering. We provide:
                </p>
                <ul className="space-y-3 ml-6">
                  <li className="flex items-start gap-3">
                    <span className="text-[#FFD700] mt-2">•</span>
            ...
            <section>
              ...
              <div className="space-y-6 text-[#E0E0E0] leading-relaxed text-lg">
                <div>
              ...
              <div className="space-y-4 text-[#E0E0E0] leading-relaxed text-lg">
                ...
                <div>
                  ...
                  <ul className="space-y-2 ml-6">
                    <li>• Email: <a href="mailto:support@promptforge.com" className="text-[#FFD700] hover:text-[#FFD700]/80 underline">support@promptforge.com</a></li>
                    <li>• Documentation: <Link href="/docs" className="text-[#FFD700] hover:text-[#FFD700]/80 underline">/docs</Link></li>
              ...
              <div className="space-y-4 text-[#E0E0E0] leading-relaxed text-lg">
                ...
                <div className="bg-gray-900/20 border border-gray-800 rounded-lg p-6">
                  ...
                  <a 
                    ...
                    className="text-[#FFD700] hover:text-[#FFD700]/80 underline text-lg"
                  >
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-6">
              <div className="bg-gray-900/20 border border-gray-800 rounded-lg p-6">
                <h3 className="text-xl font-semibold mb-4 text-[#FFD700]">Quick Navigation</h3>
                <nav className="space-y-3">
                  <a href="#service" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Service Description</a>
                  <a href="#rights" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Usage Rights</a>
                  <a href="#plans" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Plan Entitlements</a>
                  <a href="#limitations" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Limitations</a>
                  <a href="#refunds" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Refunds & Support</a>
                  <a href="#termination" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Termination</a>
                  <a href="#contact" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">Contact</a>
                </nav>
              </div>

              <div className="mt-6 bg-gray-900/20 border border-gray-800 rounded-lg p-6">
                <h3 className="text-xl font-semibold mb-4 text-[#FFD700]">Related Documents</h3>
                <div className="space-y-3">
                  <Link href="/privacy" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">
                    Privacy Policy
                  </Link>
                  <Link href="/legal" className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors">
                    Legal Hub
                  </Link>
                  <a 
                    href="https://gdpr.eu" 
                    ...
                    className="block text-[#E0E0E0] hover:text-[#FFD700] transition-colors"
                  >
                    GDPR Information
                  </a>
                </div>
        ...
        <div className="text-center mt-16">
          <button
            onClick={scrollToTop}
            className="inline-flex items-center gap-2 bg-[#FFD700] text-black px-6 py-3 rounded-lg hover:bg-[#FFD700]/80 transition-colors font-semibold"
          >
