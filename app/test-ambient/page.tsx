  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-center">🎮 Ambient Mode Test Page</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#5a5a5a]/30">
            ...
            <div className="space-y-2">
              ...
              <p>
                <strong>Animations:</strong> {motionMode === 'off' ? 'Disabled (CSS)' : 'Enabled'}
              </p>
            </div>
          </div>
        ...
        <div className="bg-[#1a1a1a] p-6 rounded-lg border border-[#5a5a5a]/30">
          ...
          <div className="text-sm space-y-2 font-mono">
            <p>
              ...
              <code>
                html[data-motion="off"] * {`{`} animation: none !important; transition: none
                !important; {`}`}
              </code>
            </p>
            <p>
              <strong>Background:</strong> <code>&lt;BackgroundRoot ambient /&gt;</code>
            </p>
            <p>
