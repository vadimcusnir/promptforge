-- PromptForge Database Migration 002
-- Multi-tenant organizations and membership with RLS
-- Provides complete tenant isolation at database level
...
-- Only owners can create new organizations (handled in application logic)
...
-- Owners can update any member, admins can update members (not owners/admins)
...
-- Owners and admins can remove members (with last owner protection from trigger)
