    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-950/20 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-xl mb-4">
            <Zap className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-white font-mono mb-2">
            Welcome Back to <span className="text-emerald-400">PromptForge</span>
          </h1>
          <p className="text-slate-400">Sign in to access your operational prompt engine</p>
        </div>
        ...
        <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <div className="mb-4 p-3 bg-emerald-900/20 border border-emerald-600/30 rounded-lg">
              <p className="text-emerald-400 text-sm font-mono mb-2">Demo Credentials:</p>
              <div className="text-xs font-mono text-slate-300 space-y-1">
                <div>Admin: admin@chatgpt-prompting.com / admin123</div>
                <div>User: user@chatgpt-prompting.com / user123</div>
              </div>
            </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="bg-slate-900/50 border-slate-600 text-white placeholder-slate-400 focus:border-emerald-500 pr-10"
                    required
                  />
                  <button
                    type="button"
