    ...
    <section id="7d-parameters" className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <h1 className="text-4xl font-bold text-white">
          <span className="text-[#d1a954]">7D Parameters</span> Engine
        </h1>
      ...
      <div className="space-y-6">
        {parameters.map((param, index) => (
          <div key={param.name} className="bg-[#0e0e0e] border border-[#5a5a5a]/30 rounded-xl p-6">
            <div className="flex items-start gap-4 mb-4">
              <div className="w-8 h-8 bg-[#d1a954] rounded-full flex items-center justify-center text-black font-bold text-sm">
                {index + 1}
              </div>
              <div className="flex-1">
                <h3 className="text-xl font-bold text-[#d1a954] mb-2">{param.name}</h3>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                    ...
                    <span
                      ...
                      className={`px-3 py-1 rounded-full text-xs font-medium ${
                        value === param.defaultValue
                          ...
                          : "bg-[#1a1a1a] text-white/80 border border-[#5a5a5a]/30"
                      }`}
                    >
                      {value}
                    </span>
                ...
                <p className="text-white/60 text-xs mt-2">
                  Default: <span className="text-[#d1a954]">{param.defaultValue}</span>
                </p>
              </div>
