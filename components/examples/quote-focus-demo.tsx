    ...
    <div className="space-y-6 p-6 glass-card max-w-2xl mx-auto">
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-300 text-sm">
          Use the toggle button to manually activate/deactivate quote focus mode. This reduces
          overlay opacity and matrix token visibility by ~35%.
        </p>
        <button
          onClick={() => set(!active)}
          className={`px-4 py-2 rounded-lg font-medium transition-all ${
            active ? 'bg-gold-industrial text-black' : 'bg-gray-700 text-white hover:bg-gray-600'
          }`}
        >
      ...
      <div className="space-y-3">
        ...
        <p className="text-gray-300 text-sm">
          This quote automatically triggers focus mode when visible. Perfect for narrative quotes,
          testimonials, or important messages.
        </p>
        <button
        ...
        {showAutoQuote && (
          <QuoteBlock className="italic text-gray-200">
            "When this quote appears, the background automatically dims and matrix tokens fade to
            improve readability and focus. This creates a cinematic effect that draws attention to
            important content."
      ...
      <div className="bg-black/20 rounded-lg p-4 border border-gray-700">
        ...
        <div className="text-sm text-gray-300 space-y-2">
          <p>
            ...
            <code className="bg-gray-800 px-1 rounded">useQuoteFocus()</code> hook
          </p>
          <p>
            <strong>For automatic control:</strong> Use{' '}
            <code className="bg-gray-800 px-1 rounded">QuoteBlock</code> component
          </p>
          <p>
            <strong>UI Overlay Policy:</strong> SSOT enforcement with GPU acceleration and reduced
            motion support
          </p>
          <p>
            <strong>Performance:</strong> &lt;50ms route transitions, &lt;20ms quote focus
            activation
          </p>
        </div>
      </div>
