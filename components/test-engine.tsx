...
export function TestEngine({
  ...
  const comparison =
    testResults.length > 1 ? compareTestResults(testResults) : null;
    ...
    <Card className="glass-effect p-6 glow-accent">
      <div className="flex items-center justify-between mb-4">
        ...
        {currentTest && (
          <Badge
            variant={
              currentTest.status === "success" ? "default" : "destructive"
            }
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value: any) =>
                setTestOptions({ ...testOptions, mode: value })
              }
            >
        ...
        <div className="flex flex-wrap gap-4">
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setTestOptions({ ...testOptions, validateKPIs: !!checked })
              }
            />
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setTestOptions({ ...testOptions, checkGuardrails: !!checked })
              }
            />
            <label
              htmlFor="checkGuardrails"
          ...
          <div className="flex items-center space-x-2">
            <Checkbox
              ...
              onCheckedChange={(checked) =>
                setTestOptions({ ...testOptions, simulateFailures: !!checked })
              }
            />
            <label
              htmlFor="simulateFailures"
              className="text-sm text-foreground"
            >
              Simulate Failures
            </label>
      ...
      <div className="mb-6">
        <Button
          ...
          disabled={!generatedPrompt || isRunning}
          ...
          <div className="p-4 glass-strong rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(currentTest.scores.structure)}`}
                >
                  {currentTest.scores.structure}%
                </div>
                <div className="text-xs text-muted-foreground">Structure</div>
                <Progress
                  value={currentTest.scores.structure}
                  className="w-full mt-1 h-1"
                />
              </div>
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(currentTest.scores.kpiCompliance)}`}
                >
                ...
                <Progress
                  value={currentTest.scores.kpiCompliance}
                  className="w-full mt-1 h-1"
                />
              </div>
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(currentTest.scores.clarity)}`}
                >
                  {currentTest.scores.clarity}%
                </div>
                <div className="text-xs text-muted-foreground">Clarity</div>
                <Progress
                  value={currentTest.scores.clarity}
                  className="w-full mt-1 h-1"
                />
              </div>
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(currentTest.scores.executability)}`}
                >
                ...
                <Progress
                  value={currentTest.scores.executability}
                  className="w-full mt-1 h-1"
                />
              </div>
              <div className="text-center">
                <div
                  className={`text-2xl font-bold ${getScoreColor(currentTest.scores.overall)}`}
                >
                  {currentTest.scores.overall}%
                </div>
                <div className="text-xs text-muted-foreground">Overall</div>
                <Progress
                  value={currentTest.scores.overall}
                  className="w-full mt-1 h-1"
                />
              </div>
            </div>
          ...
          <div className="p-4 glass-strong rounded-lg">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              ...
              <div>
                ...
                <span className={getScoreColor(currentTest.scores.overall)}>
              ...
              <div>
                ...
                {currentTest.timestamp.toLocaleTimeString("en-US")}
              </div>
            </div>
          </div>
        </div>
