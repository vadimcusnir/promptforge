...
import { Zap, Crown, Sparkles, TrendingUp, Building2 } from 'lucide-react';
      ...
      >
        <div className="text-center space-y-6">
          <div className="flex justify-center">
            <div className="p-4 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-full"></div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-lg text-slate-300 max-w-2xl mx-auto">
              {feature} requires advanced enterprise features to deliver maximum performance and
              reliability
            </p>
            {upgradeMessage && (
              <p className="text-sm text-amber-300 font-medium">{upgradeMessage.secondary}</p>
            )}
          </div>
              ...
              >
                <div className="text-center space-y-4">
                  <div className="flex justify-center">
                    ...
                    {tier.id === 'enterprise' && <Building2 className="w-8 h-8 text-purple-400" />}
                  </div>
