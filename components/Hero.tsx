    ...
    <section className="min-h-[100dvh] grid place-items-center px-4">
      <div className="max-w-3xl w-full text-center">
        ...
        <p className="mt-4 text-lg text-white/80">
          Turn 4h of tweaking into 30m of execution. 50 Modules + 7D Engine →
          Scored ≥80 & Export‑ready.
        </p>
          ...
          <a
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.boxShadow =
                "0 0 0 1px var(--pf-gold-500), 0 8px 24px rgba(199,168,105,.18)";
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.boxShadow =
                "0 10px 28px rgba(199,168,105,.18)";
            }}
            href="/generator"
