...
export function Footer() {
  ...
  return (
    <footer role="contentinfo" className="bg-background border-t border-accent/20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            <h3 className="font-montserrat font-semibold text-foreground mb-4">Navigation</h3>
            <ul className="space-y-2">
          ...
          <div>
            ...
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-muted-foreground text-sm">Industrial Prompt Engineering</span>
            </div>
        ...
        <div className="pt-8 border-t border-border">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-muted-foreground text-sm">© PromptForge™ 2025. All rights reserved.</div>
