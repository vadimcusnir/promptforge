...
interface ComingSoonContentProps {
  ...
  subtitle?: string;
  /** Whether to show the digital rune background element */
  showDigitalRune?: boolean;
}
          ...
          <>
            ...
            >
              <input
                ...
                className="w-full h-10 px-3 text-sm rounded border bg-white/10 backdrop-blur-sm border-white/20 text-white placeholder:text-white/60 focus:outline-none focus:ring-2 focus:ring-[hsl(var(--accent))] focus:border-transparent transition-all"
                required
                disabled={isLoading}
              />
              <input
