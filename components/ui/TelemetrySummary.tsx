    ...
    <div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          ...
          <Badge variant="outline" className="text-xs text-gold-industrial border-gold-industrial/30">
        ...
        <div className="pt-2 border-t border-lead-gray/20">
          <div className="text-xs text-lead-gray">
            Checksum: <code className="text-white font-mono">{Math.random().toString(36).substring(2, 10)}</code>
          </div>
        </div>
      </div>
    </div>
